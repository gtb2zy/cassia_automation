...
class Test_api(unittest.TestCase):
	...
	testdata = ExcelUtil.ExcelUtil('C:/Users/Administrator/Desktop/testdata.xlsx')
	dd = testdata.get_all()
	sdk = api.api('http://172.16.30.100/api','CC:1B:E0:E1:11:44','tester','10b83f9a2e823c47')
	...
	def test_get_device_connect_state(self,values):
		...
		if expect_result =='connected':
			self.sdk.disconnect_device(device)
			self.sdk.connect_device(device,'public',0,10000)
			while 1:
				if message['handle']==device:
					self.assertEqual(message['connectionState'],expect_result)
					self.sdk.disconnect_device(device)
					message =None
					break
		else:
...
if __name__ == '__main__':
	...
	example_dir = 'C:/Users/Administrator/Desktop/test/APItest/reports'
